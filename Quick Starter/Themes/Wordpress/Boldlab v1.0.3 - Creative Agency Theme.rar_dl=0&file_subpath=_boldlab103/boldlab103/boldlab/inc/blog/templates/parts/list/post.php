	...
	<div class="qodef-e-inner">
		...
		<div class="qodef-e-content">
			...
			<div class="qodef-e-text">
				<?php
				// Include post title
				boldlab_template_part( 'blog', 'templates/parts/post-info/title', '', array( 'title_tag' => 'h3' ) );
				
				// Include post excerpt
				boldlab_template_part( 'blog', 'templates/parts/post-info/excerpt' );
			...
			<div class="qodef-e-info qodef-info--bottom">
				<div class="qodef-e-info-left">
					...
					boldlab_template_part( 'blog', 'templates/parts/post-info/read-more' );
					?>
				</div>
