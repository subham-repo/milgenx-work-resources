...
function faq_init() {
	$labels = array(
		'name'               => _x( 'Video Testimonial', 'post type general name', 'your-plugin-textdomain' ),
		'singular_name'      => _x( 'Video Testimonial', 'post type singular name', 'your-plugin-textdomain' ),
		'menu_name'          => _x( 'Video Testimonial', 'admin menu', 'your-plugin-textdomain' ),
		'name_admin_bar'     => _x( 'Video Testimonial', 'add new on admin bar', 'your-plugin-textdomain' ),
		'add_new'            => _x( 'Add New', 'Video Testimonial', 'your-plugin-textdomain' ),
		'add_new_item'       => __( 'Add New Video Testimonial', 'your-plugin-textdomain' ),
		'new_item'           => __( 'New Video Testimonial', 'your-plugin-textdomain' ),
		'edit_item'          => __( 'Edit Video Testimonial', 'your-plugin-textdomain' ),
		'view_item'          => __( 'View Video Testimonial', 'your-plugin-textdomain' ),
		'all_items'          => __( 'All Video Testimonial', 'your-plugin-textdomain' ),
		'search_items'       => __( 'Search Video Testimonial', 'your-plugin-textdomain' ),
		'parent_item_colon'  => __( 'Parent Video Testimonial:', 'your-plugin-textdomain' ),
	...
	$args = array(
		...
		'show_in_menu'       => true,
		'query_var'          => true,
		'rewrite'            => array( 'slug' => 'video_testimonial' ),
		'capability_type'    => 'post',
		'has_archive'        => true,
		'hierarchical'       => false,
		'menu_position'      => null,
