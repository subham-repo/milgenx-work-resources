<div class="col-md-6 col-sm-6 col-xs-12 blox-box_wrap">
	<div class="blog-box view-row">
		<?php
		$post_thumb_url = get_the_post_thumbnail_url();
		if(!empty($post_thumb_url)){?>
		<div class="blog-box_thumb have_thumb">
			<a href="<?php the_permalink(); ?>">
				<img src="<?php echo $post_thumb_url; ?>" alt="<?php echo $getTheTitle; ?>" />
			</a>
		</div>
		<?php } else{ ?>
			<div class="blog-box_thumb no_thumb">
				<a href="<?php the_permalink(); ?>">
					<img src="<?php echo site_url(); ?>/wp-content/uploads/2020/06/cwc-placeholder-1.jpg" alt="<?php echo $getTheTitle; ?>" />
				</a>
			</div>
		<?php } ?>
