...
<section id="primary" class="post-content">
	<div id="content" role="main">
		<div class="container">
			...
			<!--Sidebar blog single page goes here-->
				<div role="complementary" class="widget-area right_sidebar nw_left" id="secondary" style="margin:0px;">
					<!--Articles of Content Section goes here-->
					<div class="table_content single_blog_t_con">
					...
					<!--Articles of Content Section ends here-->
					<div class="desk">
					 <?php dynamic_sidebar('posts_sidebar');?>		
					</div>
				</div>
			<!--Sidebar blog single page ends here-->
			</div>
			<div class="content-part col-md-8 col-sm-12 col-xs-12">
				...
				<div class="single_blog_pagepost_content margin_top_15px">
						...
						while ( have_posts() ) : the_post();
							...
							<div class="single_blog_content">
								<div class="single_blog_page_posts_thumb right_aligned_single">
									...
									{	?>
										<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('', array('title' => "$getTheTitle",'alt' => "$getTheTitle")); ?></a>
									<?php }	?>
								</div>
								<?php the_content(); ?>
							</div>
					...
					<div class="review_sec_wrapper_ medical-state-city-section">
						<div class="upper_date_block">
							<p>Medically Reviewed: September 25, 2019</p>
						</div>
						<div class="review_sec">
							<div class="lft_wrap">
								<div class="lft_img">
									<img alt="Dr Ashley" src="<?php echo get_site_url();?>/wp-content/uploads/2020/03/drashleymurray.png" />
								</div>
						...
						<div class="bottom_content_sec hide_full">
