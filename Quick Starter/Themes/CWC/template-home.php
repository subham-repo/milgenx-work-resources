...
<section id="home_body">
	...
	<div class="video_testimonial home_testimonial full-width section-spacing">
		<div class="container">
			...
			<?php
			$args = array( 'post_type' => 'aiovg_videos', 'post_status' => 'publish', 'posts_per_page' => 4, );		
			...
			?>
			  <div class="col-md-3 col-sm-6 col-xs-12 video_testimonial_catalog">
					<a href="<?php the_permalink(); ?>" class="vid_testi_inner full-width">
						<?php if(!empty($video_featured_thumb)){ ?>
				...
				<div class="single_posts_section_small col-lg-4 col-md-4 col-sm-6 col-xs-12">
					...
					<div class="post_blocks_thumb cool">
						...
						{	
							...
							?>
							<a class="dektopblogbgshow" href="<?php the_permalink(); ?>"><img src="<?php echo $getBgUrl; ?>" alt="<?php the_title(); ?>"></a>
							<?php 
						} 
						else
						{	?>
