...
function optionsframework_options() {
	...
	$options[] = array(
		...
		'desc' => __('Please enter Address', 'options_check'),
		'id' => 'contact_address',
		'type' => 'text');

	$options[] = array(
		'name' => __('Map Address Link', 'options_check'),
		'desc' => __('Please Enter Map Address Link', 'options_check'),
		'id' => 'map_address',
		'type' => 'text');
	...
	$options[] = array(
		'name' => __('Contact Page Link', 'options_check'),
		'desc' => __('Please Enter Contact Page Link', 'options_check'),
		'id' => 'contact_link',
		'type' => 'text');

	$options[] = array(
		'name' => __('Contact CTA Button Text', 'options_check'),
		'desc' => __('Please Enter Contact CTA Button Text For Header Title Section', 'options_check'),
		'id' => 'contact_bt_text',
		'type' => 'text');

	
	$options[] = array(
		'name' => __('Footer CTA', 'options_check'),
		'type' => 'heading');

	$options[] = array(
		'name' => __('Footer CTA intro heading', 'options_check'),
		'desc' => __('Please enter intro heading', 'options_check'),
		'id' => 'fcta_heading',
		'type' => 'textarea');

	$options[] = array(
		'name' => __('Footer CTA intro description', 'options_check'),
		'desc' => __('Please enter intro description', 'options_check'),
		'id' => 'fcta_desc',
		'type' => 'textarea');

	$options[] = array(
		'name' => __('Footer CTA contact text', 'options_check'),
		'desc' => __('Please enter contact button text', 'options_check'),
		'id' => 'fcta_btxt',
		'type' => 'text');
	...
	$options[] = array(
		'name' => __('Footer CTA call heading', 'options_check'),
		'desc' => __('Please enter call us heading', 'options_check'),
		'id' => 'fcta_chead',
		'type' => 'text');

	$options[] = array(
		'name' => __('Footer CTA call description', 'options_check'),
		'desc' => __('Please enter call us description', 'options_check'),
		'id' => 'fcta_cdesc',
		'type' => 'textarea');
